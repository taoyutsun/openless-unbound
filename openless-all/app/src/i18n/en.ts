...
export const en: typeof zhCN = {
  ...
  history: {
    ...
    repolish: {
      title: 'Polish again',
      hint: 'Reprocess the original transcript without changing this history entry or your active style.',
      retry: 'Retry original style',
      retrying: 'Retrying…',
      apply: 'Apply',
      applying: 'Processing…',
      pickStyle: 'Choose style',
      clear: 'Clear results',
      resultTitle: '{{name}} result',
      retryResultTitle: 'Retry result',
      empty: 'The model returned no text.',
      failed: 'Polish failed: {{err}}',
      timeout: 'The current LLM provider did not respond in time. Try again later or choose a faster model.',
      packsLoadFailed: 'Could not load styles: {{err}}',
    },
